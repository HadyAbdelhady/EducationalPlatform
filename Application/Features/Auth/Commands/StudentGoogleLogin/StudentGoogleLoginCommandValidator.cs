...
{
    /// <summary>
    /// Validator for StudentGoogleLoginCommand to ensure all required fields are provided correctly.
    /// </summary>
    public class StudentGoogleLoginCommandValidator : AbstractValidator<StudentGoogleLoginCommand>
    {
