...
namespace Application.Features.Auth.Commands.UserLoginWithRefreshToken
{
                                                    ...
                                                    :IRequestHandler<LoginWithRefreshTokenCommand, AuthResponse>
    {
        ...
        {
            var refreshToken = await _unitOfWork.RefreshTokens.GetRefreshTokenAsync(request.RefreshToken, cancellationToken)
            ...
            await _unitOfWork.RefreshTokens.AddRefreshTokenAsync(newRefreshToken, request.UserId, cancellationToken);
