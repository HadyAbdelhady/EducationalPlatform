...
{
    public class GetAllQuestionsInExamQueryHandler(IUnitOfWork unitOfWork) : IRequestHandler<GetAllQuestionsInExamQuery, Result<PaginatedResult<AllQuestionsInExamResponse>>>
    {
        private readonly IUnitOfWork _unitOfWork = unitOfWork;

        public async Task<Result<PaginatedResult<AllQuestionsInExamResponse>>> Handle(GetAllQuestionsInExamQuery request, CancellationToken cancellationToken)
        {
            try
            {
